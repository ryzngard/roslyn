...
namespace Microsoft.CodeAnalysis.Editor.Implementation.AddImports
{
    ...
    internal class VisualBasicAddImportsPasteCommandHandler : AbstractAddImportsPasteCommandHandler
    {
        [ImportingConstructor]
        [Obsolete(MefConstruction.ImportingConstructorMessage, error: true)]
        public VisualBasicAddImportsPasteCommandHandler(IThreadingContext threadingContext) : base(threadingContext)
        {
        }

        public override string DisplayName => EditorFeaturesWpfResources.Add_Missing_Imports_on_Paste;
        protected override string DialogText => EditorFeaturesWpfResources.Adding_missing_imports;
    }
}
